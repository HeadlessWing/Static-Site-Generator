...
class TestTextNode(unittest.TestCase):
    ...
    def test_eq_url(self):
        node = TextNode("testing", TextType.BOLD, None)
        node2 = TextNode("testing", TextType.BOLD)
        self.assertEqual(node, node2)

    def test_not_eq(self):
        node = TextNode("testing", TextType.BOLD, "url")
        node2 = TextNode("testing", TextType.BOLD)
        self.assertNotEqual(node, node2)
    ...
    def test_split_2(self):
        node = TextNode("`code` regular text `code` regular text", TextType.TEXT)
        new_nodes = split_nodes_delimiter([node], "`", TextType.CODE)
        self.assertEqual(new_nodes, [
    ...
    def test_split_image_none(self):
        ...
        self.assertListEqual(
            [
                TextNode("[image](https://www.example.COM/IMAGE.PNG)", TextType.TEXT),
            ],
            new_nodes,
        )
